...
leveneTest(abundancia~ambiente,data=tabela) # Teste de homogeneidade das variãveis
# Não é aplicado para lm: TukeyHSD(anova_com_lm) #Teste de Tukey para verificar quais pares mostram-se diferentes
...
tapply(chocolate$Sabor, chocolate$Tipo, mean) # Aplica média para o saber em cada Tipo
